...
<section class="page-section">
  <div class="page-shell page-shell--narrow">
    ...
    <ul class="check-list">
      ...
      <li>Selling your current home and deciding what should happen next.</li>
      <li>Coordinating a sale and purchase without creating unnecessary pressure.</li>
